...
\begin{itemize}[itemsep=-2pt]
    \item Drag e resize dei widget ora sono direttive riusabili invece di codice ripetuto in ogni componente.
    \item Tolto un po' di codice inutilizzato e uniformati alcuni nomi.
