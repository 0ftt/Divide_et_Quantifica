...
\begin{itemize}[itemsep=-2pt]
    \item Meno codice ripetuto: le parti comuni dei widget (trascinamento, ridimensionamento e intestazione) ora sono componenti e direttive riusabili, invece di essere copiate in ognuno.
    \item Tolto codice e stili non più usati e uniformati alcuni nomi.
    \item Rimosso il widget orologio, che aveva poco uso.
    \item I messaggi di errore del server ora sono codici tradotti dal client, così seguono la lingua scelta.
    \item Aggiunto il braccialetto DeQ nel profilo, che si sblocca con il Premium e il profilo completo.
\end{itemize}